...
export default function StudentView(data: StudentBundle) {
  ...
  const orbitNodes: { label: string; icon: string; count: number; color: string; pos: string; rotate: string; type: PopupType }[] = [
    ...
    { label: "Group",    icon: "👥", count: group ? 1 : 0,   color: "#3b82f6", pos: "right-0 top-1/2 -translate-y-1/2 translate-x-12",  rotate: "0deg",   type: "group"    },
    ...
    { label: "Student",  icon: "🎓", count: 1,                color: "#10b981", pos: "left-0 top-1/2 -translate-y-1/2 -translate-x-12",  rotate: "180deg", type: "students" },
  ];
