...
export default function EditStudentModal({
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-8 pt-8 pb-4 shrink-0 modal-header sticky top-0 z-10 border-b border-border-light bg-white dark:bg-[#94a3b838] overflow-hidden">
        ...
        >
            ...
            <div className="flex-1">
              ...
              <div className="mt-1">
                <CustomSelect
                  ...
                  options={Object.keys(TYPE_COLOR).map((t) => ({
                    value: t,
                    label: t,
                  }))}
                />
          ...
          <div className="flex gap-3">
            <div className="flex-1">
              ...
              <input
                ...
                value={form.started}
                onChange={(e) =>
                  setForm((f) => ({ ...f, started: e.target.value }))
                }
                className={field()}
              />
            </div>
            <div className="flex-1">
              ...
              <input
                ...
                value={form.finished}
                onChange={(e) =>
                  setForm((f) => ({ ...f, finished: e.target.value }))
                }
                className={field()}
              />
            </div>
          ...
          <div>
            ...
            <input
              value={form.exam_project_url}
              onChange={(e) =>
                setForm((f) => ({ ...f, exam_project_url: e.target.value }))
              }
