...
export default function AddStudentModal({ uniqueGroups, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-8 pt-8 pb-4 shrink-0 modal-header sticky top-0 z-10 border-b border-border-light bg-white overflow-hidden dark:bg-[#94a3b838]">
